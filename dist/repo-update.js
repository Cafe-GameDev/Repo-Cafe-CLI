...
☕ Uso: repo-update
   ...
   os melhores grãos!
`;
var repoOwner = "Cafe-GameDev";
var repoName = "Repo-Cafe";
var repoUrl = `https://github.com/${repoOwner}/${repoName}/archive/refs/heads/main.zip`;
var contextDir = path.join(os.homedir(), ".gemini");
var zipPath = path.join(contextDir, "context.zip");
var versionFilePath = path.join(contextDir, "version.json");
...
ERRO: Falha ao baixar o conteúdo do repositório.`, e);
  ...
  try {
    ...
    const extractedFolderName = fs.readdirSync(contextDir).find((f) => f.startsWith("Repo-Cafe-"));
